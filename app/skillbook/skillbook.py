...
class SkillbookApp(BaseApp):
    ...
    def _handle_save_settings(self, data: dict, language: str) -> dict:
        ...
        try:
            ...
            self.save_config({'skillbook.language': str(language_id)})
    ...
    def _handle_get_comments(self, data: dict, language: str) -> dict:
        ...
        try:
            ...
            for comment in comments:
                ...
                if user_id:
                    info = account_module.enrich_user_info(account_db_path, user_id)
                    comment['display_name'] = info['display_name']
                    comment['avatar_small'] = info['avatar_small']
                    comment['avatar_mime'] = info['avatar_mime']
